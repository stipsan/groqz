...
const query1 = groq`*[_type in ["category", "page"]]{..., category->{title}}`
const query2 = groq`*[_type == "category"]{title, _type, "image": image.asset->{url, size}}[0]`
const query3 = groq`*[_type == "movie"]`
